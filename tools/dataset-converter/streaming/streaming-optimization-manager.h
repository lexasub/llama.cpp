...
private:
    ...
    std::unique_ptr<llama_dataset_streaming_read_ahead> read_ahead;
    std::unique_ptr<llama_dataset_streaming_memory_monitor> memory_monitor;
...
public:
    ...
    struct OptimizationStats {
        llama_dataset_streaming_cache::CacheStats cache_stats;
        llama_dataset_streaming_read_ahead::Status read_ahead_status;
        llama_dataset_streaming_memory_monitor::MemoryInfo memory_info;
        uint64_t access_count;
        uint64_t sequential_access_count;
        uint64_t random_access_count;
